namespace FishAquarium.Configs
{
    public class AquariumInitializer// : DropCreateDatabaseIfModelChanges<AquariumContext>
    {
        protected /*override */void Seed(FishAquariumContext context)
        {
